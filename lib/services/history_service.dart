...
class HistoryService {
  ...
  static Future<void> saveUpdateHistory(String passwordId) async {
    History updateHistory =
        History.create(action: 'update', password: passwordId);
    await updateHistory.init();
    await updateHistory.push();
  }
